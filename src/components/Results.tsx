...
const Results = ({ score, results, subject = "Mixed Topics", onRetakeQuiz, onBackToDashboard }: ResultsProps) => {
  ...
  const getScoreBadge = (score: number) => {
    ...
    if (score >= 80) return { text: "Great Job!", variant: "secondary" as const, icon: Award };
    if (score >= 70) return { text: "Good Work!", variant: "secondary" as const, icon: Target };
    return { text: "Keep Practicing!", variant: "destructive" as const, icon: TrendingUp };
  };
